...
function Banner() {
  ...
  <div className='bg-[#193a53] w-full flex justify-between px-5 md:px-24 h-12 items-center   transition-all duration-1000 ease-in-out'>
...
<div className='flex gap-3 text-white  transition-all duration-1000 ease-in-out '>
